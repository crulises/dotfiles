...
require('lazy').setup({
  ...
  {                     -- Muestra los keybinds que se pueden hacer.
    ...
    opts = {
      delay = 0,
      icons = {
        -- Si nerdfont esta disponible esto se pasa a true
  ...
  { -- Fuzzy Finder (archivos, lsp)
    ...
    dependencies = {
      'nvim-lua/plenary.nvim',
      {
        ...
        -- `build` se usa para correr comandos cuando el plugin se instala/actualiza.
        build = 'make',
        -- `cond` condicion que determina si el plugin debe ser instalado o cargado.
        cond = function()
